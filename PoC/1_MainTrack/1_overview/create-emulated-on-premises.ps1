...
$rg = "poc-emulated-on-premises-rg"
...
New-AzVirtualNetwork -ResourceGroupName $rg -Location $location -Name $VnetName -AddressPrefix 10.152.1.0/22
...
#$JumpBoxConfig = New-AzVMConfig -VMName $vmname -VMSize $VMSize | Set-AzVMOperatingSystem -Windows -ComputerName $vmname -Credential $adminCred | Set-AzVMSourceImage -PublisherName "MicrosoftVisualStudio" -Offer "VisualStudio" -Skus "VS-2017-RC1-Ent-Win10-N" -Version latest | Add-AzVMNetworkInterface -Id $JumpBoxNic.Id

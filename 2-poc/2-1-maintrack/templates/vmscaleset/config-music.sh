...
sudo wget -O /tmp/music-store-azure-demo-pub.tar https://raw.githubusercontent.com/rodrigosantosms/aahc/master/2-poc/2-1-maintrack/templates/vmscaleset/music-store-azure-demo-pub.tar --append-output=/tmp/install.log
...
sudo wget -O /tmp/default https://raw.githubusercontent.com/Microsoft/dotnet-core-sample-templates/master/dotnet-core-music-linux/music-app/nginx-config/default --append-output=/tmp/install.log
...
sudo wget -O /etc/supervisor/conf.d/music.conf https://raw.githubusercontent.com/Microsoft/dotnet-core-sample-templates/master/dotnet-core-music-linux/music-app/supervisor/music.conf --append-output=/tmp/install.log
...
sudo wget -O /etc/init.d/musicstorestopstart.sh https://raw.githubusercontent.com/rodrigosantosms/aahc/master/2-poc/2-1-maintrack/templates/vmscaleset/musicstorestopstart.sh --append-output=/tmp/install.log
